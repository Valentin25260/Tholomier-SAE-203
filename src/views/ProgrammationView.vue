...
<div class="dark:bg-black">
  ...
  <img src="../assets/img/progra.png" class="w-full h-auto mt-4" />
  ...
  <div class="w-full flex flex-row justify-center justify-items-center mt-12">
    <RouterLink to="Concert" class=""
      ...
      >
        ...
        <img src="../assets/img/fleche.png" class="w-auto h-auto" /></div
    ></RouterLink>
  </div>
  ...
  <img src="../assets/img/scene.png" class="mt-8 w-full h-auto" />

  <div class="flex flex-row overflow-x-auto ...">
    <img src="../assets/img/image10.webp" class="mt-12 ml-3 w-1/3 h-auto" />
    <img src="../assets/img/image12.webp" class="mt-12 mx-3 w-1/3 h-auto" />
    <img src="../assets/img/image13.webp" class="mt-12 mr-3 w-1/3 h-auto" />
  </div>
